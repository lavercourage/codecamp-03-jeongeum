...
export default function BoardWriteUI(props){
    ...
    return (
        <Wrapper>
            ...
            <Section2>
                <Label>제목</Label>
                <Topic name="topic" type="text" placeholder="제목을 작성해주세요." onChange={props.onChangeLabel}/>
                <Error>{props.titleError}</Error>
            </Section2>
            <Section3>
                <Label>내용</Label>
                <Substance name="substance" type="text" placeholder="내용을 작성해주세요." onChange={props.onChangeSubstance}/>
            ...
            <Section8>
                <Submit onClick={props.onClickSubmit} qqq={props.qqq}>등록하기</Submit>
            </Section8>
        </Wrapper>
    )
}